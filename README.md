...
*(Progetti di analisi e implementazioni core)*

* **[Sentinel-RAG Analysis](https://github.com/arkemus-dev/sentinel-rag/tree/main):** Un framework RAG avanzato che utilizza **BGE-M3** per il recupero multilingua. Il progetto include una pipeline di valutazione sistematica basata su **Hit Rate** e **MRR** per ottimizzare la precisione del recupero semantico.
